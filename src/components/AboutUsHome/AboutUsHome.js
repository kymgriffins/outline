            ...
            <div className={`container ${styles.contain}`}>
                <div className="row overflow-hidden">
                    <div className="col-md-5">
                        ...
                        <p data-aos="slide-left" className={styles.heading} style={{textAlign: 'left'}}>We are Outline Designs, We create meaningful places + spaces that benefit all. </p>
                        ...
                        <div data-aos='zoom-in' style={{textAlign: 'left'}}>
                            <button className={`btn custom_btn ${styles.btn}`}> View More</button>
                        </div>
                    ...
                    <div className="col-md-7 overflow-hidden">
                        <div >
                            <div >
                                <img data-aos="zoom-in-right" src={bg101} alt=""  height={400} width="maxWidth"/>
                            </div>
